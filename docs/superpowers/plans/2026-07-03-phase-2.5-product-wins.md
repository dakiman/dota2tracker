...
- [ ] **Step 5: Refactor `meta.ts` to use it**
...
- [ ] **Step 6: Refactor `heroes.ts` the same way**
...
- [ ] **Step 1: Add `VITE_API_URL` to the vitest env**
...
- [ ] **Step 3: Wire into HeroDetailPage**
...
- [ ] **Step 3: Mirror the index in the Drizzle schema**
...
- [ ] **Step 1: Make global-setup start_times deterministic**
...
- [ ] **Step 3: Rewrite HomePage as the feed**
...
- [ ] **Step 3: Profile link in the player-filter dropdown**
